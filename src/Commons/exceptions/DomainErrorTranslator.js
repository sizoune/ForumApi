...
DomainErrorTranslator._directories = {
  ...
  'NEW_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat menambahkan thread, karena payload tidak sesuai'),
  'NEW_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat menambahkan thread, karena tipe data pada payload tidak sesuai'),
